/*!
 * @file
 * This header includes all the computations provided with the library.
 */
...
#include <react/computations/on_update.hpp>
#include <react/computations/reference.hpp>
#include <react/computations/retrieve_from_update.hpp>
